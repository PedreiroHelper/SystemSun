...
public class usuarios extends javax.swing.JFrame {
    ...
    public usuarios() {
        initComponents();
        DefaultTableModel tabelas = (DefaultTableModel) tabelausuarios.getModel();
        tabelausuarios.setRowSorter(new TableRowSorter(tabelas));
    ...
    public void mostrartabela() {
        ...
        bdusuario pdao = new bdusuario();

        for (Usuarios arg : pdao.ler()) {
    ...
    private void initComponents() {
        ...
        tabelausuarios.setForeground(new java.awt.Color(4, 2, 2));
        tabelausuarios.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Código Usuário", "Nome", "Sobrenome", "Login", "E-mail", "Telefone"
            }
        ));
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/cadastrarusuarios.png"))); // NOI18N
